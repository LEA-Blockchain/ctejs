import { CteEncoder, CteDecoder, PUBLIC_KEY_SIZE, SIGNATURE_SIZE } from '../dist/cte.node.mjs';

async function runExample() {
    try {
        console.log('--- Starting Test: Node.js ESM (dist/cte.node.mjs) ---');
        ...
        const commandPayload = 'Hello from JS via WASM (Node ESM)!';
        ...
        console.log('--- Finished Test: Node.js ESM ---');
    } catch (error) {
        console.error('--- ERROR in Node.js ESM Test ---:', error);
    }
}
